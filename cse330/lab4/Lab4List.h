...
template <class T> class RListIterator; // lab4
...
public:
	...
	riterator rbegin() const;  // these need to be defined
	riterator rend() const;    // needs to be defined ... lab4

        circulator cbegin() const;  //for lab 4
...
class RListIterator
{
 public:
	...
	RListIterator(const RListIterator<T>& other)
	{
		currentLink = other.currentLink;
	}
...
class ListCirculator
{
 public:
	...
	ListCirculator(const ListCirculator<T>& other)
	{
		currentLink = other.currentLink;
	}
...
template <class T>
ListCirculator<T> & ListCirculator<T>::operator=(const ListCirculator<T> & rhs)
{
	currentLink = rhs.currentLink;
	return *this;
}
...
template <class T>
bool ListCirculator<T>::operator==(const circulator & rhs) const
{
  return currentLink == rhs.currentLink;
