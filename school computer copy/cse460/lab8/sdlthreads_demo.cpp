/*
  ...
  Compile:  g++ -o sdlthreads_demo sdlthreads_demo.cpp -lSDL -lpthread
  Execute:  ./sdlthreads_demo
*/
...
int main ()
{
  ...
  id3 = SDL_CreateThread ( runnerInfinite, tnames[2] );
